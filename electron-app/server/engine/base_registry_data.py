...
BASE_REGISTRY = {
    ...
    "antique_chrome":   {"base_spec_fn": spec_antique_chrome, "M": 220, "R": 18,  "CC": 50,  "paint_fn": paint_antique_chrome_v2,  "desc": "Antique chrome — patina accumulation + pitting corrosion model",
    ...
    "blue_chrome":      {"base_spec_fn": spec_blue_chrome, "M": 255, "R": 2,   "CC": 16,  "paint_fn": paint_blue_chrome_v2, "desc": "Blue chrome — thin-film interference, soap bubble physics on metal (blue→purple→gold→green-blue)",
                         "noise_scales": [1, 2, 3], "noise_weights": [0.6, 0.25, 0.15], "noise_M": 20, "noise_R": 8},
    "red_chrome":       {"base_spec_fn": spec_red_chrome, "M": 220, "R": 5,   "CC": 16, "paint_fn": paint_red_chrome_v2, "desc": "Red chrome — anodization simulation, oxide layer selective wavelength absorption", "noise_scales": [2, 4], "noise_weights": [0.5, 0.5], "noise_M": 10, "noise_R": 10},
    ...
    "candy_burgundy":   {"M": 180, "R": 15, "CC": 16, "paint_fn": paint_cp_candy_burgundy, "desc": "Deep burgundy candy over chrome base — BASE-013 FIX: M=180 (candy metallic base), R=15, CC=16",
                         "perlin": True, "perlin_octaves": 4, "perlin_persistence": 0.6, "noise_R": 20},
    ...
    "candy_emerald":    {"M": 190, "R": 15,  "CC": 16, "paint_fn": paint_electric_blue_tint, "desc": "Uranium glass generating intense radioluminescence — GGX-FIX: R=2→15", "perlin": True, "perlin_octaves": 4, "noise_M": -50, "noise_R": 80},
    ...
    "ceramic_matte":    {"M": 10,  "R": 120, "CC": 160, "paint_fn": paint_none,   "desc": "Diffuse fired ceramic with intense high-frequency abrasive grit structure (CC=160 flat). FLAG-CER-001 FIX: M=10 (fired ceramic is dielectric, was M=35 — too metallic for a non-metallic fired finish)",
    ...
    "factory_basecoat": { "base_spec_fn": spec_oem_automotive,"M": 130, "R": 30,  "CC": 16, "paint_fn": paint_subtle_flake,    "desc": "Factory basecoat - standard OEM metallic, the average showroom car that left the plant",
                         "noise_scales": [2, 4, 8], "noise_weights": [0.4, 0.35, 0.25], "noise_M": 20, "noise_R": 12},
    "fire_engine":      {"M": 0,   "R": 15,  "CC": 16, "paint_fn": paint_ceramic_gloss,   "desc": "Fire engine red - deep wet apparatus red, dielectric, maximum gloss — GGX-FIX: R=6→15"},
    ...
    "police_black":     {"M": 0,   "R": 15,  "CC": 16, "paint_fn": paint_none,            "desc": "Police black - law enforcement glossy black, dielectric — GGX-FIX: R=10→15"},
    "school_bus":       { "base_spec_fn": spec_oem_automotive,"M": 0, "R": 15, "CC": 16, "paint_fn": paint_none, "desc": "School bus yellow - Federal Standard 13432 chrome yellow with UV stabilizer haze — FLAG-OEM-002 FIX: paint_none preserves correct yellow base (was paint_electric_blue_tint — cold blue hue on a warm yellow finish)"},
    ...
    "gloss_wrap":       {"M": 0,   "R": 15,  "CC": 16, "paint_fn": paint_ceramic_gloss,   "desc": "Gloss wrap - high-gloss smooth vinyl, dielectric — GGX-FIX: R=8→15"},
    ...
    "prismatic":        {"M": 200, "R": 10, "CC": 16, "paint_fn": paint_iridescent_shift, "desc": "Over-tuned holographic logic breaking standard M/R bounds to create truly impossible colors — BASE-040 FIX: CC=16 (maximum gloss for holographic)", "perlin": True, "perlin_octaves": 6, "noise_M": 255, "noise_R": 80},
    ...
    "alubeam":          { "base_spec_fn": spec_alubeam_base, "M": 245, "R": 18,  "CC": 16, "paint_fn": paint_alubeam,
                         "desc": "BASF Alubeam liquid mirror — ultra-fine oriented aluminum flake, coherent blur between chrome and metallic",
                         "noise_scales": [2, 4], "noise_weights": [0.55, 0.45], "noise_M": 8, "noise_R": 8},
    ...
    "electroplated_gold": { "base_spec_fn": spec_electroplated_gold_base, "M": 250, "R": 10, "CC": 16, "paint_fn": paint_electroplated_gold,
                         "desc": "Electroplated Gold / Rose Gold — warm mirror: near-chrome metallic with warm gold or rose-gold albedo, Rolls-Royce Bespoke reference",
                         "noise_scales": [2, 4], "noise_weights": [0.55, 0.45], "noise_M": 8, "noise_R": 10},
