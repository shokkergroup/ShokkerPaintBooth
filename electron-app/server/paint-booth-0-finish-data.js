...
const MONOLITHICS = [
    ...
    { id: "fpe_cyan_spineball", name: "Cyan Spineball", desc: "One close-cropped radiolarian cage with fine shell panels, inner windows, fracture corridors, spine roots and broken sockets.", swatch: "linear-gradient(135deg, #063f65, #24c99c, #f3e86d, #df71da)" },
...
{ id: "fmo_owl_eye", name: "Owl Eye", desc: "A close-cropped damaged wing ocellus built from six eccentric teardrop layers, fine scales, broken eyelid bars, combs, glint cuts, rupture gaps and hooked scars.", swatch: "linear-gradient(135deg, #071b36, #23944c, #b8d84e, #f0b0c9, #6f205c)" },
