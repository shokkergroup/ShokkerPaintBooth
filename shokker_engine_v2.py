...
PATTERN_REGISTRY = {
    ...
    # --- v5.0 NEW PATTERNS (12 to reach 50 total) ---
    ...
    # --- v5.5 SHOKK THE SYSTEM PATTERNS (#51-55) ---
    ...
    # --- v6.0 SHOKK PHASE PATTERNS (independent channel modulation) ---
    ...
    # --- v8.0 SHOKK SERIES ADVANCED (independent M/R channel Phase architecture) ---
    ...
    # === v7.0 PATTERN ALIASES — maps all UI patterns to closest existing renderer ===
...
MONOLITHIC_REGISTRY = {
    ...
    # --- SHOKKER COLOR SHIFT v2 — Adaptive (reads your paint color) ---
    ...
    # --- SHOKKER COLOR SHIFT v2 — Preset (bold fixed color ramps) ---
    ...
    # --- v5.0 NEW MONOLITHICS (4 to reach 25 total) ---
    ...
    # --- SHOKKER PRIZM v4 — Panel-Aware Color Shift (beats Neonizm) ---
