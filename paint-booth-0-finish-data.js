...
// =============================================================================
const PATTERNS = [
    { id: "argyle", name: "Argyle", desc: "Diamond/rhombus overlapping argyle pattern", swatch: "#886688" },
    ...
    { id: "houndstooth", name: "Houndstooth", desc: "Classic houndstooth check textile", swatch: "#776655" },
    ...
    { id: "norse_rune", name: "Norse Rune", desc: "Elder Futhark rune symbol repeating grid", swatch: "#8877aa", swatch_image: "/assets/patterns/artistic_cultural/norse_rune.jpg" },
    ...
    { id: "pentagram", name: "Pentagram", desc: "Five-pointed star geometric array", swatch: "#993355" },
...
// ============================================================
const SPEC_PATTERNS = [
    { id: "banded_rows", name: "Banded Rows", desc: "Horizontal bands with feathered transitions", category: "Structure", defaults: { num_bands: 30, palette_size: 10 } },
    ...
    { id: "panel_zones", name: "Panel Zones", desc: "Large irregular zones with different values", category: "Structure", defaults: { num_zones: 6 } },
    ...
    { id: "moire_overlay", name: "Moire Overlay", desc: "Overlapping grids creating moire interference", category: "Optical", defaults: { grid1_freq: 20 } },
    { id: "pebble_grain", name: "Pebble Grain", desc: "Large rounded bumps like leather grain", category: "Texture", defaults: { pebble_size: 15 } },
    ...
    { id: "patina_bloom", name: "Patina Bloom", desc: "Circular bloom spots from chemical reaction", category: "Weathering", defaults: { num_blooms: 20 } },
    { id: "electric_branches", name: "Electric Branches", desc: "Branching tree/lightning patterns", category: "Organic", defaults: { num_trees: 3, branch_depth: 6 } },
    // --- NEW PATTERNS (26-50) ---
    { id: "voronoi_fracture", name: "Voronoi Fracture", desc: "Shattered glass cell boundaries with dark fracture lines", category: "Crystalline", defaults: { num_cells: 40, edge_width: 2.0 } },
    ...
    { id: "acid_etch", name: "Acid Etch", desc: "Chemical dissolution eating through coating layers", category: "Weathering", defaults: { intensity: 0.6, blob_count: 30 } },
    ...
    { id: "magnetic_field", name: "Magnetic Field", desc: "Iron filing lines between magnetic poles", category: "Kinetic", defaults: { num_poles: 3, line_density: 20.0 } },
    { id: "prismatic_shatter", name: "Prismatic Shatter", desc: "Shattered prism fragments reflecting at different angles", category: "Crystalline", defaults: { num_shards: 60 } },
    ...
    { id: "heat_distortion", name: "Heat Distortion", desc: "Rising convection shimmer waves like hot asphalt", category: "Kinetic", defaults: { wave_count: 12, turbulence: 4.0 } },
    ...
    { id: "quantum_noise", name: "Quantum Noise", desc: "Standing wave interference — probability density clouds", category: "Optical", defaults: { num_waves: 30 } },
    ...
    { id: "circuit_trace", name: "Circuit Trace", desc: "PCB Manhattan-routed traces with solder pads", category: "Structure", defaults: { trace_count: 40 } },
    ...
    { id: "meteor_impact", name: "Meteor Impact", desc: "Radial crater with ejecta rays and concentric shockwaves", category: "Kinetic", defaults: { num_craters: 3 } },
    ...
    { id: "gravity_well", name: "Gravity Well", desc: "Spacetime warping around singularity — lensing distortion", category: "Optical", defaults: { num_wells: 2 } },
    { id: "sonic_boom", name: "Sonic Boom", desc: "Mach cone shockwave interference patterns", category: "Kinetic", defaults: { num_sources: 3 } },
...
const BASE_GROUPS = {
    ...
    "★ PARADIGM": ["p_superfluid", "p_coronal", "p_seismic", "p_hypercane", "p_geomagnetic", "p_non_euclidean", "p_time_reversed", "p_programmable", "p_erised", "p_schrodinger", "p_mercury", "p_phantom", "p_volcanic", "arctic_ice", "carbon_weave", "nebula", "quantum_foam", "infinite_finish"],
    "Candy & Pearl": ["candy_burgundy", "candy_cobalt", "candy_emerald", "chameleon", "iridescent", "moonstone", "opal", "spectraflame", "tinted_clear", "tri_coat_pearl", "hydrographic", "jelly_pearl", "orange_peel_gloss", "tinted_lacquer"],
    "Carbon & Composite": ["aramid", "carbon_base", "carbon_ceramic", "fiberglass", "forged_composite", "graphene", "hybrid_weave", "kevlar_base", "carbon_weave"],
    "Ceramic & Glass": ["ceramic", "ceramic_matte", "crystal_clear", "enamel", "obsidian", "piano_black", "porcelain", "tempered_glass"],
    "Chrome & Mirror": ["antique_chrome", "black_chrome", "blue_chrome", "candy_chrome", "chrome", "dark_chrome", "mirror_gold", "red_chrome", "satin_chrome", "surgical_steel", "liquid_obsidian", "terrain_chrome"],
    "Exotic Metal": ["anodized", "brushed_aluminum", "brushed_titanium", "cobalt_metal", "diamond_coat", "frozen", "liquid_titanium", "platinum", "raw_aluminum", "rose_gold", "titanium_raw", "tungsten", "organic_metal"],
    "Extreme & Experimental": ["bioluminescent", "dark_matter", "holographic_base", "neutron_star", "plasma_core", "quantum_black", "solar_panel", "superconductor", "singularity", "prismatic"],
    "Industrial & Tactical": ["armor_plate", "battleship_gray", "blackout", "cerakote", "cerakote_gloss", "duracoat", "gunship_gray", "mil_spec_od", "mil_spec_tan", "powder_coat", "sandblasted", "submarine_black", "sub_black", "vantablack"],
    "Metallic Standard": ["candy", "candy_apple", "champagne", "copper", "gunmetal", "metal_flake_base", "original_metal_flake", "champagne_flake", "fine_silver_flake", "blue_ice_flake", "bronze_flake", "gunmetal_flake", "green_flake", "fire_flake", "metallic", "midnight_pearl", "pearl", "pearlescent_white", "pewter", "satin_metal"],
...
const PATTERN_GROUPS = {
    ...
    "Artistic & Cultural": ["aztec", "aztec_alt1", "aztec_alt2", "dragon_scale", "dragon_scale_alt", "fleur_de_lis", "fleur_de_lis_alt", "japanese_wave", "mandala", "mandela_ornate", "mosaic", "muertos_dod1", "muertos_dod2", "norse_rune", "steampunk_gears"],
    "Carbon & Weave": ["basket_weave", "carbon_fiber", "kevlar_weave", "nanoweave", "basket_weave_alt", "carbon_alt_1", "carbon_weave", "exhaust_wrap_alt", "geo_weave", "hex_carbon", "multi_directional", "wavy_carbon"],
    ...
    "Geometric": ["argyle", "art_deco", "celtic_knot", "chevron", "crosshatch", "greek_key", "herringbone", "houndstooth", "pinstripe", "plaid", "tessellation"],
    "Gothic & Dark": ["barbed_wire", "gothic_cross", "gothic_scroll", "iron_cross", "pentagram", "razor_wire", "skull", "skull_wings", "spiderweb", "thorn_vine"],
