"""Build 11: BaseRotation fix + number inputs for rotation sliders"""
...
LOG = os.path.join(SERVER_DIR, '_build11_log.txt')
...
log("*** BUILD 11: BaseRotation fix + slider number inputs ***")
...
if r2.returncode == 0:
    ...
    if os.path.exists(setup):
        ...
        log(f"\n*** BUILD 11 COMPLETE: {setup} ({size_mb:.1f} MB) ***")
    else:
